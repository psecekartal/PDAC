...
print(p.taxa.bar)
ggsave(p.taxa.bar, file=paste0(PARAM$folder.results, "16S/tissue_16S.bar_chart.tax_composition.pdf"), height = 8, width = 10, useDingbats=F)
...
print(p.contam.bar)
ggsave(p.contam.bar, file=paste0(PARAM$folder.results, "16S/tissue_16S.bar_chart.contam_composition.pdf"), height = 8, width = 10, useDingbats=F)
...
print(p.taxa.point)
ggsave(p.taxa.point, file=paste0(PARAM$folder.results, "16S/tissue_16S.boxplot.tax_composition.pdf"), height = 10, width = 10, useDingbats=F)
```
...
ggsave(p.diff_abd.tissue.family, file=paste0(PARAM$folder.results, "16S/tissue_16S.diff_abd.tumor_healthy.family_all.pdf"), height = 12, width = 8, useDingbats=F)
...
write.table(data.family_all.p, file=paste0(PARAM$folder.results, "16S/tissue_16S.diff_abd.tumor_healthy.family_all.tsv"), sep="\t", row.names = F, quote=F)
```
...
ggsave(p.diff_abd.tissue.species, file=paste0(PARAM$folder.results, "16S/tissue_16S.diff_abd.tumor_healthy.species_all.pdf"), height = 12, width = 8, useDingbats=F)
```
